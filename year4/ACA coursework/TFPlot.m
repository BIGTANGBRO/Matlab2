...
% 用于从以下文本文件导入数据的脚本:
%
%    C:\Users\tangj\Desktop\Code\Matlab2\year4\ACA coursework\aoa2.dat
%
% 要将代码扩展到其他选定数据或其他文本文件，请生成函数来代替脚本。

% 由 MATLAB 自动生成于 2021/12/13 19:14:37

%% 初始化变量。
filename = 'C:\Users\tangj\Desktop\Code\Matlab2\year4\ACA coursework\aoa2.dat';
startRow = 17;
endRow = 116;
