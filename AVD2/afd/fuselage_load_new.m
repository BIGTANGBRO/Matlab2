...
f_t=deg2rad(0.4)*6.83*0.5*0.379597*(0.75*296.535)^2*11.69; % tail force
w_t(219)=f_t;
...
mom=sum(w_tot*dx.*x)+w_t.*x+w_0.*x;
right=[-trapz(w_tot,x)-w_t-w_0;-mom]
left=[1,1;11.3,13];
r=left\right;
w_w(113)=r(1);
w_w(130)=r(2);
