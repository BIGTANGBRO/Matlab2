...
F(2*(nelx*round(170/520)+1)*(nely*round(111.6/203.2)+1),1) = -1;
fixeddofs   = union([2*(nelx*round(30/520)+1)*(nely*round(81.6/203.2)+1)],[2*(nelx*round(490/520+1))*(nely*round(81.6/203.2+1))]);
