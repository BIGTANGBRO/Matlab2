...
deltaE_landing=[0*30,-0.06*30,-0.12*30,-0.24*30,-0.29*30,-0.38*30].*pi./180;
scatter(deltaE_landing,CL_landing,'r*');
pdeltaE_landing = polyfit(deltaE_landing,CL_landing,1);
disp(1./pdeltaE_landing);
hold on
...
deltaE_landing=[-0.003*30,-0.048*30,-0.087*30,-0.203*30,-0.357*30,-0.558*30].*pi./180;
...
deltaE_landing=[0.1652*14,0.1071*14,0.01603*14,-0.03469*30,-0.1479*30,-0.2368*30].*pi./180;
...
ylabel('CL')
xlabel('Elvator deflection in radian');
grid on
