...
w1w0 = 0.995;
w2w1 = 0.980;
w3w2 = exp(-8500*10^3*0.0001389/(237.6*17.18*0.866));
w4w3 = 0.990;
w5w4 = 0.980;
w6w5 = exp(-370*10^3*0.0001389./(Vmin*(3^(1/4)/(sqrt(0.5152)))*17.18*0.866));
w7w6 = exp(-45*60*0.0001111/17.18);
w8w7 = 0.980;
w9w8 = 0.992;
...
Wb=(2+6+250)*20; %Weight of baggages
...
grid minor
xlabel('W_0/kg','FontSize',16)
ylabel('W_0/kg','FontSize',16)
