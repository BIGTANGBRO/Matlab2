...
penalCnt = { 1, 3, 25 , 0.25 }; % continuation scheme on penal
betaCnt = { 1, 2 , 25 , 2 }; % continuation scheme on beta
...
fprintf ( ’It .:%5 i C :%7.4 f V :%7.3 f ch .:%0.2 e penal :%7.2 f beta :%7.1 f eta :%7.2 f \n’, ...
