...
grid on
legend('Metallic Alloy(Aluminium)','Polymer(Delrin)','Composite(Carbon Fibre)');
xlabel('True Strain');
...
grid on
legend('True Stress over True Strain','Nominal Stress over Nominal Strain')
xlabel('Strain of Carbon Fibre');
ylabel('Stress of Carbon Fibre(Pa)')
hold off
...
grid on
legend('True Stress over True Strain','Nominal Stress over Nominal Strain')
xlabel('Strain of Aluminium');
ylabel('Stress of Aluminium(Pa)')
hold off
